...
const recoms = [
    {
        ...
        description: "Разработчики молодцы, сайт огонь! Мне очень понравилось!"
    },{
      name: "Andy",
      avatar: "A",
      title: "Web Designer",
      description: "Отличный сайт! Особенно понравился UI/UX дизайн!",
    },
    { name: "Ольга",
      avatar: "O", 
      title: "Content Manager", 
      description: "Поддержка клиентов на высшем уровне, всегда на связи и готовы помочь в любое время." 
    },
    {
      name: "Аня",
      avatar: "A",
        ...
        <div className="px-10 pb-20"> 
          ...
          <div className="flex flex-row justify-center gap-4 text-white pt-4">
            <Link href="https://github.com/pharaohchik/ai-app">
              ...
              <p className="text-zinc-400 text-sm font-medium pl-1" style={{ marginLeft: '-4px' }}>dron</p>
            </Link>
            ...
            <Link href="https://t.me/math_is_ez">
              ...
              <p className="text-zinc-400 text-sm font-medium pl-1" style={{ marginLeft: '-2px' }}>goga</p>
            </Link>
